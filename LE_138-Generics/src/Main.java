...
//        adelaideCrows.addPlayer(beckham);
        ...
        Team<SoccerPlayer> dunavRuse = new Team<>("Dunav Ruse");
        dunavRuse.addPlayer(beckham);
...
//        adelaideCrows.matchResult(baseballPlayerTeam, 1, 1);
        ...
        League<Team<FootballPlayer>> league = new League<>("IFL");
        league.add(adelaideCrows);
        league.add(melbourne);
        league.add(hawthorn);
        league.add(fremantle);

//        league.add(baseballPlayerTeam);
